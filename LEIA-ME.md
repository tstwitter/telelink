...
Use https://tstwitter.github.io/telelink/?bot=hubTS. Para trocar o bot, altere somente o endereço correspondente ao nome. Para adicionar outro, acrescente uma entrada. Nomes aceitam letras maiúsculas ou minúsculas sem acentos, números, hífen e sublinhado, até 64 caracteres.
...
Envie index.html, redirect.js, config.json e .nojekyll para a raiz do repositório. Em Settings → Pages, escolha GitHub Actions e siga ATIVAR-BOT.md para configurar o controle pelo Telegram. Aguarde a publicação e teste o endereço mostrado com ?bot=loiras (ou um nome cadastrado).
...
Controle por comandos implementado via GitHub Actions; consulte ATIVAR-BOT.md para ativar os Secrets e a publicação. Apenas o administrador autorizado pode criar e trocar destinos. Alertas de publicação e falhas estão incluídos. Detecção de bots removidos ainda não está implementada. Nunca exponha tokens no repositório ou na página.
